...
<head>
    ...
    <!-- Summernote plugin -->
    <link href="<?= base_url(); ?>/css/summernote-lite.min.css" rel="stylesheet">
...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Visitbaubau <?= date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    $('.summernote').summernote({
        ...
        callbacks: {
            ...
            onPaste: function(e) {
                const bufferText = ((e.originalEvent || e).clipboardData || window.clipboardData).getData(
                    'Text');
                e.preventDefault();
    ...
    <script>
    function previewProposalEvent() {
        const fileProposal = document.querySelector('#proposal_event');
        const proposalEventLabel = document.querySelector('.custom-file-label');
        const filePreview = document.querySelector('.file-preview');

        proposalEventLabel.textContent = fileProposal.files[0].name; //sampul -> fiels -> index ke 0 -> namanya
