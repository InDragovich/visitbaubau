    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/event/update/<?= $result['id_event']; ?>" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="fileProposalEventLama" value="<?= $result['proposal_event']; ?>">
                <div class="row mb-3">
                    <div class="col">
                        <label for="nama_event"><b>Nama Event</b></label><input id="nama_event" name="nama_event"
                            for="nama_event"
                            class="form-control <?= $validation->hasError('nama_event') ? 'is-invalid' : ''; ?>"
                            type="text" placeholder="" value="<?= old('nama_event', $result['nama_event']); ?>">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="nama_penyelenggara"><b>Penyelenggara</b></label><input id="nama_penyelenggara"
                            name="nama_penyelenggara" for="nama_penyelenggara"
                            class="form-control <?= $validation->hasError('nama_penyelenggara') ? 'is-invalid' : ''; ?>"
                            type="text" placeholder=""
                            value="<?= old('nama_penyelenggara', $result['nama_penyelenggara']); ?>">
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select
                            ...
                            <option value="<?= $ke['id_kategori_event']; ?>" id="id_kategori_event"
                                <?= old('id_kategori_event', $result['id_kategori_event']) == $ke['id_kategori_event'] ? 'selected' : ''; ?>>
                    ...
                    <div class="col">
                        <label for="lokasi_event"><b>Lokasi Event</b></label><input id="lokasi_event"
                            name="lokasi_event" for="lokasi_event"
                            class="form-control <?= $validation->hasError('lokasi_event') ? 'is-invalid' : ''; ?>"
                            type="text" placeholder="" value="<?= old('lokasi_event', $result['lokasi_event']); ?>">
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    <div class="col-sm-3">
                        <label for="tgl_event_mulai"><b>Tanggal Dimulai</b></label><input id="tgl_event_mulai"
                            name="tgl_event_mulai" for="tgl_event_mulai"
                            class="form-control <?= $validation->hasError('tgl_event_mulai') ? 'is-invalid' : ''; ?>"
                            type="date" placeholder=""
                            value="<?= old('tgl_event_mulai', $result['tgl_event_mulai']); ?>">
                        <div class="invalid-feedback">
                            <?= $validation-> getError('tgl_event_mulai'); ?>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <label for="tgl_event_berakhir"><b>Tanggal Berakhir</b></label><input id="tgl_event_berakhir"
                            name="tgl_event_berakhir" for="tgl_event_berakhir"
                            class="form-control <?= $validation->hasError('tgl_event_berakhir') ? 'is-invalid' : ''; ?>"
                            type="date" placeholder=""
                            value="<?= old('tgl_event_berakhir', $result['tgl_event_berakhir']); ?>">
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="deskripsi_event"><b>Deskripsi</b></label><textarea
                            ...
                            value="<?= old('deskripsi_event'); ?>"><?= $result['deskripsi_event']; ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col">
                        <div class="custom-file">
                            <input type="file"
                                ...
                                onchange="previewProposalEvent()">
                            <div class="invalid-feedback">
                                <?= $validation-> getError('proposal_event'); ?>
                            </div>
                            <label class="custom-file-label" for="customFile">Upload Proposal&nbsp;<span
                ...
                <div class="row mb-3">
                    <div class="col">
                        <p>Preview Gambar<br>
                            <img id="imgPreview" width="200px" src="/img/event/<?= $result['gambar_event']; ?>"
