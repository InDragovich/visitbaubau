                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <div class="card-body-desc">
                            ...
                            <a type="button" href="#" class="btn btn-success" data-toggle="modal"
                                data-target="#verifikasiModal"><i class="fas fa-check"></i>
                                Approve</a>
                            <a href="<?= base_url('admin/event/'); ?>" class="btn btn-danger"><i
                                    class="fas fa-window-close"></i>Tolak</a>
                            <?php } ?>
                            ...
                            <a href="<?= base_url('admin/event/edit-event/'.$event['slug']); ?>"
