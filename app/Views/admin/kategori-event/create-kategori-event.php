    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/kategorievent/save" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="nama_kategori_event"><b>Nama Kategori</b></label><input id="nama_kategori_event"
                            ...
                            type="text" placeholder="" value="<?= old('nama_kategori_event'); ?>">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="deskripsi_kategori_event"><b>Deskripsi</b></label><input
                            ...
                            type="text" placeholder="" value="<?= old('deskripsi_kategori_event'); ?>">
                        <div class="invalid-feedback">
