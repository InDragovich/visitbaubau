                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('admin/' . $user->userid); ?>"
                                            class="btn btn-primary btn-circle btn-sm" title="Detail">
                                            <i class="fas fa-user"></i>
                                        </a>
                                        <a href="<?= base_url('admin/changePassword/'. $user->userid); ?>"
                                            class="btn btn-warning btn-circle btn-sm" title="Ubah Password">
                                            <i class="fas fa-key"></i>
                                        </a>
                                        <a href="#" class="btn btn-success btn-circle btn-sm btn-change-role"
                                            data-id="<?= $user->userid;?>" title="Ubah Role">
                                            <i class="fas fa-tasks"></i>
                                        </a>
                                        <a href="<?= base_url('admin/edit/'. $user->userid); ?>"
                                            class="btn btn-info btn-circle btn-sm btn-change-role"
                                            data-id="<?= $user->userid;?>" title="Hapus User">
