...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-700"><b>Tambah Data Artikel</b></h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/kategoriwisata/save" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="nama_kategori_wisata"><b>Nama Kategori</b></label><input id="nama_kategori_wisata"
                            ...
                            type="text" placeholder="" value="<?= old('nama_kategori_wisata'); ?>">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="deskripsi_kategori_wisata"><b>Deskripsi</b></label><input
                            id="deskripsi_kategori_wisata" name="deskripsi_kategori_wisata"
                            for="deskripsi_kategori_wisata"
                            class="form-control <?= $validation->hasError('deskripsi_kategori_wisata') ? 'is-invalid' : ''; ?>"
                            type="text" placeholder="" value="<?= old('deskripsi_kategori_wisata'); ?>">
                        <div class="invalid-feedback">
