    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/wisata/update/<?= $result['id_wisata']; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="nama_wisata"><b>Nama Wisata</b></label><input id="nama_wisata" name="nama_wisata"
                            for="nama_wisata"
                            class="form-control <?= $validation->hasError('nama_wisata') ? 'is-invalid' : ''; ?>"
                            type="text" placeholder="" value="<?= old('nama_wisata', $result['nama_wisata']); ?>">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="alamat_wisata"><b>Alamat</b></label><textarea
                            class="form-control <?= $validation->hasError('alamat_wisata') ? 'is-invalid' : ''; ?>"
                            id="alamat_wisata" name="alamat_wisata" for='alamat_wisata' rows="3"
                            value="<?= old('alamat_wisata'); ?>"><?= $result['alamat_wisata']; ?></textarea>
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="deskripsi_wisata"><b>Deskripsi</b></label><textarea
                            ...
                            value="<?= old('deskripsi_wisata'); ?>"><?= $result['deskripsi_wisata']; ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col">
                        ...
                        <select
                            ...
                            <option value="<?= $kw['id_kategori_wisata']; ?>" id="id_kategori_wisata"
                                <?= old('id_kategori_wisata', $result['id_kategori_wisata']) == $kw['id_kategori_wisata'] ? 'selected' : ''; ?>>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <p>Preview Gambar<br>
                            <img id="imgPreview" width="200px" src="/img/wisata/<?= $result['gambar_wisata']; ?>"
                                class="img-thumbnail img-preview">
                        </p>
                    </div>
                </div>

                <button type='submit' class="btn btn-primary" href="/wisata/edit">Update Data</button>
