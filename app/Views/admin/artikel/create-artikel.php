    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/artikel/save" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="judul_artikel"><b>Judul Artikel</b>&nbsp;&nbsp;<span
                                class="badge badge-light bg-gray-200"
                                style="color: grey;"><b>Wajib</b></span></label><input id="judul_artikel"
                            name="judul_artikel" for="judul_artikel"
                            class="form-control <?= $validation->hasError('judul_artikel') ? 'is-invalid' : ''; ?>"
                            type="text" placeholder="" value="<?= old('judul_artikel'); ?>">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="isi_artikel"><b>Isi Artikel</b>&nbsp;&nbsp;<span
                                class="badge badge-light bg-gray-200"
                            ...
                            value="<?= old('isi_artikel'); ?>"><?= old('isi_artikel'); ?></textarea>
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="tgl_artikel"><b>Tanggal Upload</b>&nbsp;&nbsp;<span
                                class="badge badge-light bg-gray-200"
                                style="color: grey;"><b>Wajib</b></span></label><input id="tgl_artikel"
                            name="tgl_artikel" for="tgl_artikel"
                            class="form-control <?= $validation->hasError('tgl_artikel') ? 'is-invalid' : ''; ?>"
                            type="date" placeholder="" value="<?= old('tgl_artikel'); ?>">
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <p>Preview Gambar<br>
                            <img id="imgPreview" width="200px" src="/img/artikel/default.jpg"
